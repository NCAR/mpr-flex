...
contains
  ...
  subroutine popMeta(err,message)
    ...
    parMaster(ixPar%h4)                = par_meta('h4'      ,     1.0_dp,  0.8_dp , 1.2_dp, 2, .False.)
    parMaster(ixPar%h5)                = par_meta('h5'      ,     1.0_dp,  0.8_dp , 1.2_dp, 2, .False.)
    parMaster(ixPar%binfilt)           = par_meta('binfilt' ,     1.0_dp,  0.8_dp , 1.2_dp, 2, .False.)
