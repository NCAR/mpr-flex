...
subroutine paramMaster(err,message)
  ...
  gammaMeta(ixGamma%phi1gamma2)      = par_meta('phi1gamma2'     ,  -0.142_dp,   -0.8_dp,   -0.4_dp,"phi"      ,     1, "soil", .False.,      "na", -999.0_dp,       "na", -999.0_dp,.False.)
  gammaMeta(ixGamma%phi1gamma3)      = par_meta('phi1gamma3'     ,  -0.037_dp,   -0.8_dp,   -0.4_dp,"phi"      ,     1, "soil", .False.,      "na", -999.0_dp,       "na", -999.0_dp,.False.)
  ...
  !b transfer function
  gammaMeta(ixGamma%b1gamma1)        = par_meta('b1gamma1'       ,     3.1_dp,   -0.8_dp,   -0.4_dp,"b"        ,     1, "soil", .False.,      "na", -999.0_dp,       "na", -999.0_dp,.False.)
  gammaMeta(ixGamma%b1gamma2)        = par_meta('b1gamma2'       ,   0.157_dp,   -0.8_dp,   -0.4_dp,"b"        ,     1, "soil", .False.,      "na", -999.0_dp,       "na", -999.0_dp,.False.)
  gammaMeta(ixGamma%b1gamma3)        = par_meta('b1gamma3'       ,  -0.003_dp,   -0.8_dp,   -0.4_dp,"b"        ,     1, "soil", .False.,      "na", -999.0_dp,       "na", -999.0_dp,.False.)
  !saturation matric potential transfer function
  gammaMeta(ixGamma%psis1gamma1)     = par_meta('psis1gamma1'    ,    1.54_dp,    0.8_dp,    0.4_dp,"psis"     ,     1, "soil", .False.,      "na", -999.0_dp,       "na", -999.0_dp,.False.)
  gammaMeta(ixGamma%psis1gamma2)     = par_meta('psis1gamma2'    , -0.0095_dp,   -0.8_dp,   -0.4_dp,"psis"     ,     1, "soil", .False.,      "na", -999.0_dp,       "na", -999.0_dp,.False.)
  gammaMeta(ixGamma%psis1gamma3)     = par_meta('psis1gamma3'    ,  0.0063_dp,    0.8_dp,    0.4_dp,"psis"     ,     1, "soil", .False.,      "na", -999.0_dp,       "na", -999.0_dp,.False.)
  ...
  betaMeta(ixBeta%twm)             = par_meta('twm'            ,     1.0_dp,    0.8_dp,    1.2_dp,     "beta",  -999,  "soil", .False.,  "pnorm",    1.0_dp,   "pnorm",    1.0_dp, .True.)
  betaMeta(ixBeta%fwm)             = par_meta('fwm'            ,     1.0_dp,    0.8_dp,    1.2_dp,     "beta",  -999,  "soil", .False.,  "pnorm",    1.0_dp,   "pnorm",    1.0_dp, .True.)
  betaMeta(ixBeta%fsm)             = par_meta('fsm'            ,     1.0_dp,    0.8_dp,    1.2_dp,     "beta",  -999,  "soil", .False.,  "pnorm",    1.0_dp,   "pnorm",    1.0_dp, .True.)
  betaMeta(ixBeta%fpm)             = par_meta('fpm'            ,     1.0_dp,    0.8_dp,    1.2_dp,     "beta",  -999,  "soil", .False.,  "pnorm",    1.0_dp,   "pnorm",    1.0_dp, .True.)
