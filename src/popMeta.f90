...
subroutine paramMaster(err,message)
  ...
  parMaster(ixPar%ks1gamma1)       = par_meta('ks1gamma1'      ,   -0.6_dp ,  -0.66_dp,  -0.54_dp,"ks"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%ks1gamma2)       = par_meta('ks1gamma2'      , 0.0126_dp , 0.0113_dp, 0.0139_dp,"ks"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%ks1gamma3)       = par_meta('ks1gamma3'      ,-0.0064_dp ,-0.0058_dp,-0.0070_dp,"ks"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%ks2gamma1)       = par_meta('ks2gamma1'      ,   54.0_dp ,   48.6_dp,   59.4_dp,"ks"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%ks2gamma2)       = par_meta('ks2gamma2'      ,  -0.07_dp , -0.077_dp, -0.063_dp,"ks"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%ks2gamma3)       = par_meta('ks2gamma3'      , -0.167_dp ,   -0.8_dp,   -0.4_dp,"ks"       , "soil", .False.,      "na",       "na",.False.)
  !pororsity transfer function
  parMaster(ixPar%phi1gamma1)      = par_meta('phi1gamma1'     ,    50.5_dp,   45.5_dp,   55.5_dp,"phi"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%phi1gamma2)      = par_meta('phi1gamma2'     ,  -0.142_dp,   -0.8_dp,   -0.4_dp,"phi"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%phi1gamma3)      = par_meta('phi1gamma3'     ,  -0.037_dp,   -0.8_dp,   -0.4_dp,"phi"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%phi2gamma1)      = par_meta('phi2gamma1'     ,    0.76_dp,   -0.8_dp,   -0.4_dp,"phi"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%phi2gamma2)      = par_meta('phi2gamma2'     ,  0.0009_dp,   -0.8_dp,   -0.4_dp,"phi"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%phi2gamma3)      = par_meta('phi2gamma3'     ,  -0.264_dp,   -0.8_dp,   -0.4_dp,"phi"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%phi2gamma4)      = par_meta('phi2gamma4'     ,    0.89_dp,   -0.8_dp,   -0.4_dp,"phi"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%phi2gamma5)      = par_meta('phi2gamma5'     ,  -0.001_dp,   -0.8_dp,   -0.4_dp,"phi"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%phi2gamma6)      = par_meta('phi2gamma6'     ,  -0.324_dp,   -0.8_dp,   -0.4_dp,"phi"      , "soil", .False.,      "na",       "na",.False.)
  !field capacity transfer function
  parMaster(ixPar%fc1gamma1)       = par_meta('fc1gamma1'      ,     1.0_dp,    0.8_dp,    1.2_dp,"fc"       , "soil", .False.,      "na",       "na",.False.)
  !wilting point transfer function
  parMaster(ixPar%wp1gamma1)       = par_meta('wp1gamma1'      ,     1.0_dp,    0.8_dp,    1.2_dp,"wp"       , "soil", .False.,      "na",       "na",.False.)
  !b transfer function
  parMaster(ixPar%b1gamma1)        = par_meta('b1gamma1'       ,     3.1_dp,   -0.8_dp,   -0.4_dp,"b"        , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%b1gamma2)        = par_meta('b1gamma2'       ,   0.157_dp,   -0.8_dp,   -0.4_dp,"b"        , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%b1gamma3)        = par_meta('b1gamma3'       ,  -0.003_dp,   -0.8_dp,   -0.4_dp,"b"        , "soil", .False.,      "na",       "na",.False.)
  !saturation matric potential transfer function
  parMaster(ixPar%psis1gamma1)     = par_meta('psis1gamma1'    ,    1.54_dp,    0.8_dp,    0.4_dp,"psis"     , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%psis1gamma2)     = par_meta('psis1gamma2'    , -0.0095_dp,   -0.8_dp,   -0.4_dp,"psis"     , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%psis1gamma3)     = par_meta('psis1gamma3'    ,  0.0063_dp,    0.8_dp,    0.4_dp,"psis"     , "soil", .False.,      "na",       "na",.False.)
  !specific yield transfer function
  parMaster(ixPar%myu1gamma1)      = par_meta('myu1gamma1'     ,     3.5_dp,   3.85_dp,   3.15_dp,"myu"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%myu1gamma2)      = par_meta('myu1gamma2'     ,    1.66_dp,   1.83_dp,   1.50_dp,"myu"      , "soil", .False.,      "na",       "na",.False.)
  ! total depth multiplier
  parMaster(ixPar%z1gamma1)        = par_meta('z1gamma1'       ,     1.0_dp,    0.1_dp,    4.0_dp,"z"        , "soil", .False.,      "na",       "na",.False.)
  ! layer fractions
  parMaster(ixPar%h1gamma1)        = par_meta('h1gamma1'       ,    0.05_dp,   0.01_dp,    0.1_dp,"h"        , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%h1gamma2)        = par_meta('h1gamma2'       ,     0.3_dp,   0.12_dp,    0.5_dp,"h"        , "soil", .False.,      "na",       "na",.False.)
  ! transfer function
  parMaster(ixPar%binfilt1gamma1)  = par_meta('binfilt1gamma1' ,     0.0_dp,   -2.0_dp,    1.0_dp,"binfilt"  , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%binfilt1gamma2)  = par_meta('binfilt1gamma2' ,     1.0_dp,    0.8_dp,    1.2_dp,"binfilt"  , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%D11gamma1)       = par_meta('D11gamma1'      ,     2.0_dp,   1.75_dp,    3.5_dp,"D1"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%D21gamma1)       = par_meta('D21gamma1'      ,     2.0_dp,   1.75_dp,    3.5_dp,"D2"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%D31gamma1)       = par_meta('D31gamma1'      ,     1.0_dp,  0.001_dp,    2.0_dp,"D3"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%D41gamma1)       = par_meta('D41gamma1'      ,     2.0_dp,    1.2_dp,    2.5_dp,"D4"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%exp1gamma1)      = par_meta('exp1gamma1'     ,     3.0_dp,    0.8_dp,    1.2_dp,"exp"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%exp1gamma2)      = par_meta('exp1gamma2'     ,     2.0_dp,    0.8_dp,    1.2_dp,"exp"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%bbl1gamma1)      = par_meta('bbl1gamma1'     ,    0.32_dp,    0.8_dp,    1.2_dp,"bbl"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%bbl1gamma2)      = par_meta('bbl1gamma2'     ,     4.2_dp,    0.8_dp,    1.2_dp,"bbl"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%bd1gamma1)       = par_meta('bd1gamma1'      ,     1.0_dp,    0.9_dp,    1.1_dp,"bd"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%sd1gamma1)       = par_meta('sd1gamma1'      ,     1.0_dp,    0.9_dp,    1.1_dp,"sd"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%WcrFrac1gamma1)  = par_meta('WcrFrac1gamma1' ,     1.0_dp,    0.8_dp,    1.2_dp,"WcrFrac"  , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%WpwpFrac1gamma1) = par_meta('WpwpFrac1gamma1',     1.0_dp,    0.8_dp,    1.2_dp,"WcrFrac"  , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%fsm1gamma1)      = par_meta('fsm1gamma1',          1.0_dp,    0.8_dp,    1.2_dp,"fwm"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%zk1gamma1)       = par_meta('zk1gamma1',           1.6_dp,    1.4_dp,    1.8_dp,"zk"       , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%zsk1gamma1)      = par_meta('zsk1gamma1',          1.6_dp,    1.4_dp,    1.8_dp,"zsk"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%zsk1gamma2)      = par_meta('zsk1gamma2',          2.0_dp,    1.8_dp,    2.2_dp,"zsk"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%zpk1gamma1)      = par_meta('zpk1gamma1',          1.0_dp,    0.8_dp,    1.2_dp,"zpk"      , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%pfree1gamma1)    = par_meta('pfree1gamma1',        1.6_dp,    1.4_dp,    1.8_dp,"pfree"    , "soil", .False.,      "na",       "na",.False.)
  parMaster(ixPar%rexp1gamma1)     = par_meta('rexp1gamma1',        0.03_dp,   0.02_dp,   0.04_dp,"rexp"     , "soil", .False.,      "na",       "na",.False.)
  ! -----
