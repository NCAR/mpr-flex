...
subroutine popMprMeta(err,message)
  ...
  vprp_meta(ixPrpVeg%lai01)             = var_meta('lai01'         ,"Jan lai"                                            ,"m2 m-2"      ,"1D", "double")
  vprp_meta(ixPrpVeg%lai02)             = var_meta('lai02'         ,"Feb lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai03)             = var_meta('lai03'         ,"Mar lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai04)             = var_meta('lai04'         ,"Apr lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai04)             = var_meta('lai05'         ,"May lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai04)             = var_meta('lai06'         ,"Jun lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai04)             = var_meta('lai07'         ,"Jul lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai04)             = var_meta('lai08'         ,"Aug lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai04)             = var_meta('lai09'         ,"Sep lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai04)             = var_meta('lai10'         ,"Oct lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai04)             = var_meta('lai11'         ,"Nov lai"                                            ,"m2 m-2"      ,"1D", "double" )
  vprp_meta(ixPrpVeg%lai04)             = var_meta('lai12'         ,"Dec lai"                                            ,"m2 m-2"      ,"1D", "double" )
