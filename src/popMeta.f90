...
subroutine paramMaster(err,message)
  ...
  parMaster(ixPar%rmin)            = par_meta('rmin'           ,     1.0_dp,    0.8_dp,    1.2_dp,     "beta",  -999,   "veg", .False.,  "pnorm",    1.0_dp,      "na", -999.0_dp, .False.)
  parMaster(ixPar%lai)             = par_meta('lai'            ,     1.0_dp,    0.8_dp,    1.2_dp,     "beta",  -999,   "veg", .False.,  "pnorm",    1.0_dp,      "na", -999.0_dp, .False.)
